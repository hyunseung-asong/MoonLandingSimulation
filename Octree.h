...
public:
	...
	bool intersectNodeList(const Box& box, TreeNode& node, vector<TreeNode>& nodeListRtn);
	...
	glm::vec3 getAverageNormal(vector<TreeNode>& nodeList);
	glm::vec3 getAverageBoxCenter(vector<Box>& colBoxList);
